						...
						<div class="col-md-8">
							<div class="row">
								<div class="col-md-12">
									...
									<h5>( 회원등급:
									<c:if test="${loginInfo.user_authority =='1'}">일반</c:if>
									<c:if test="${loginInfo.user_authority =='2'}">VIP</c:if>
									<c:if test="${loginInfo.user_authority =='3'}">MANAGER</c:if>
									<c:if test="${loginInfo.user_authority =='4'}">MASTER</c:if>
								...
								<div class="col-md-12" style="padding-top: 30px;">
									...
									<c:if test="${empty myOrder}">
										<div class="jumbotron card card-block">
											<p>오늘의 주문내역이 없습니다.</p>
											<p><a class="btn btn-primary btn-large" href="/foodList.do" 
												style="background-color: #c19f76; border: 1px solid;">맛있는 커피 주문하러 가기</a></p>
										</div>
									</c:if>
									<%-- 주문내역이 있는 경우 --%>
											...
											<c:forEach var="myOrder" items="${myOrder}">
												<div class="orderDiv col-md-4" onclick="getOrderInfo('${myOrder.order_code}')" style="padding: 20px;">
													<div class="card h-100">
														<h6 class="card-header" style="background-color: #c19f76; color:#fff;
														...
														<div class="card-footer" style="background-color: #c19f76;
															display: flex; justify-content: center; text-align: center;">
															<h6 style="color:#fff;">${myOrder.product_name}
																<c:if test="${myOrder.whole_quantity > 1}">
																<br>외 ${myOrder.whole_quantity-1} 건</c:if>
															</h6>
														</div>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-md-12" style="padding-top: 30px;">
									...
									<c:if test="${empty myBook}">
										<div class="jumbotron card card-block">
											<p>오늘의 대여내역이 없습니다.</p>
											<p><a class="btn btn-primary btn-large" href="/bookList.do"
												style="background-color: #c19f76; border: 1px solid;">도서 목록 보러 가기</a></p>
										</div>
									</c:if>
									<%-- 대여중인 도서가 있는 경우 --%>
