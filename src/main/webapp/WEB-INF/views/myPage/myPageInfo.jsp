         ...
         <div class="row" style="margin-top: 50px;">
            <div class="col-md-4"></div>
               ...
               <div style="display: flex; justify-content: space-between; align-items: center;">
                <h3>내 정보</h3>
               <a href="myPageInfo_modify" class="btn btn-primary" style="background-color: #c19f76; border: 1px solid;">회원정보 수정</a>
               </div>
               <br>
               <div class="container">
                 <form>
                  ...
                  <hr>
                  <button type="button" id="btn-deleteInfo" class="btn btn-danger" style="background-color: #766650; border: 1px solid;">회원탈퇴</button>
                 </form>
               </div>
            </div>
            <div class="col-md-4"></div>
